                            ...
                            <?php if ($this->session->userdata('akses') == 'Administrator') { ?>
                                <li class="menu-item  has-sub">
                                    <a href="#" class='menu-link'>
                                        <span><i class="fas fa-users"></i> Super Admin</span>
                                    </a>
                                        ...
                                        <div class="submenu-group-wrapper">
                                            ...
                                            <ul class="submenu-group">
                                                ...
                                                <li class="submenu-item  ">
                                                    <a href="<?= base_url('admin/daftar_akun'); ?>" class='submenu-link'>Daftar Mahasiswa</a>
                                                </li>



                                                <li class="submenu-item  ">
                                                    <a href="<?= base_url('admin/daftar_akun/dosen'); ?>" class='submenu-link'>Daftar Dosen</a>
                                    ...
                                    <div class="submenu ">
                                        ...
                                        <div class="submenu-group-wrapper">
                                            ...
                                            <ul class="submenu-group">
                                                ...
                                                <li class="submenu-item  ">
                                                    <a href="<?= base_url('') ?>" class='submenu-link'>Daftar Mahasiswa</a>
                                                ...
                                                <li class="submenu-item  ">
                                                    <a href="#" class='submenu-link'>Validasi KRS Mahasiswa</a>
                                    ...
                                    <div class="submenu ">
                                        ...
                                        <div class="submenu-group-wrapper">
                                            ...
                                            <ul class="submenu-group">
                                                ...
                                                <li class="submenu-item  ">
                                                    <a href="<?= base_url() ?>Dosen/Matkul" class='submenu-link'>Jadwal Kelas Perkuliahan</a>
                                                ...
                                                <li class="submenu-item  ">
                                                    <a href="#" class='submenu-link'>Agenda Hari Perkuliahan</a>
                                                ...
                                                <li class="submenu-item  ">
                                                    <a href="#" class='submenu-link'>Absensi Perkuliahan</a>


                                                </li>
                                                <li class="submenu-item  ">
                                                    <a href="#" class='submenu-link'>RPS</a>
                                    ...
                                    <div class="submenu ">
                                        ...
                                        <div class="submenu-group-wrapper">
                                            ...
                                            <ul class="submenu-group">
                                                ...
                                                <li class="submenu-item  ">
                                                    <a href="#" class='submenu-link'>Kartu Rencana Studi Online</a>
                                                ...
                                                <li class="submenu-item  ">
                                                    <a href="#" class='submenu-link'>Kartu Hasil Studi</a>
                                                ...
                                                <li class="submenu-item  ">
                                                    <a href="#" class='submenu-link'>Jadwal Perkuliahan</a>


                                                </li>
                                                <li class="submenu-item  ">
                                                    <a href="#" class='submenu-link'>Kuesioner Penilaian Dosen</a>
                                    ...
                                    <div class="submenu ">
                                        ...
                                        <div class="submenu-group-wrapper">
                                            ...
                                            <ul class="submenu-group">
                                                ...
                                                <li class="submenu-item  ">
                                                    <a href="#" class='submenu-link'>Kartu Rencana Studi</a>
                                                ...
                                                <li class="submenu-item  ">
                                                    <a href="#" class='submenu-link'>Ringkasan Hasil Studi</a>


                                                </li>
                                                <li class="submenu-item  ">
                                                    <a href="#" class='submenu-link'>Transkrip Mahasiswa</a>


                                                </li>
                                                <li class="submenu-item  ">
                                                    <a href="#" class='submenu-link'>Kartu Ujian Mahasiswa</a>


                                                </li>
                                                <li class="submenu-item  ">
                                                    <a href="#" class='submenu-link'>Laporan Kustom</a>
                                    ...
                                    <div class="submenu ">
                                        ...
                                        <div class="submenu-group-wrapper">
                                            ...
                                            <ul class="submenu-group">
                                                ...
                                                <li class="submenu-item  ">
                                                    <a href="#" class='submenu-link'>Pembayaran Tagihan</a>
                                                ...
                                                <li class="submenu-item  ">
                                                    <a href="#" class='submenu-link'>Pembayaran Manual</a>
