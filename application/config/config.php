...
|
*/
$config['base_url'] = 'https://localhost/sia/';
// $config['base_url'] = 'https://peruvian-documentat.000webhostapp.com/';

// //start setting virtual host base url
// $config['base_url'] = "http://".$_SERVER['HTTP_HOST'].
// str_replace(basename($_SERVER['SCRIPT_NAME']),"",$_SERVER['SCRIPT_NAME']);
//end setting virtual host base url
